...
<footer className="bg-[#DAEEF9]">
    <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:mb-8 flex justify-center space-x-6 md:order-3  ">
            <a href="https://www.facebook.com/" className="text-black hover:text-gray-200">
            ...
            <a href="https://github.com/ifatimahali" target='_blank' className="text-black hover:text-gray-200">
